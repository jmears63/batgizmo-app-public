...
public final class UsbDescriptorParser {
     ...
     * to be parsed (and parse them). Useful for parsing a stored descriptor audio_buffer.
     */
    ...
    */
    ...
    public String getDescriptorString(int stringId) {
        // Avoid the need to connect to the device to get the strings:
        return String.format("<%d>", stringId);
